        ...
        <div className="dashboard-container">
            ...
            <div className="dashboard-header">
                <div className="d-flex justify-content-between align-items-center mb-3">
                    <span className="dashboard-time">9:30 PM</span>
                    <button className="logout-btn d-flex align-items-center gap-2" onClick={handleLogout}>
                        <i className="bi bi-box-arrow-right"></i> Logout
                    </button>
                </div>

                <div className="text-center mb-4">
                    <div className="profile-image-container mx-auto mb-2">
                        <img
                            src="../images/ellipseimage.jpg"
                            className="profile-image w-100 h-100"
                            alt="profile"
                        />
                    </div>
                    <h2 className="welcome-text">Welcome {user?.fullName || 'Jeegar goyani'}</h2>
                    <p className="greeting-text mb-0">{getGreeting()}</p>
            ...
            <div className="dashboard-content">
                ...
                {showAddForm && (
                    <div className="add-task-form mb-4">
                        <h5 className="form-title">Add New Task</h5>
                        <form onSubmit={handleAddTask}>
                            ...
                            <input
                                type="text"
                                className="form-input w-100"
                                placeholder="Time (e.g., 12PM)"
                                value={newTask.time}
                                onChange={(e) => setNewTask({ ...newTask, time: e.target.value })}
                                required
                            />
                            <div className="d-flex gap-2 mt-3">
                                <button type="submit" className="submit-btn flex-grow-1">
                                    Add Task
                                </button>
                                <button
                                    type="button"
                                    className="cancel-btn flex-grow-0"
                ...
                <div className="daily-task-section">
                    <h4 className="daily-task-title">Daily Task</h4>
